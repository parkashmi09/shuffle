...
/**
 * One member's delivery and read state for a banner notification.
 *
 * RECONSTRUCTED. `club_banner_notification_status` was referenced by mounted routes and never existed.
 */
class ClubBannerNotificationStatus extends Model {}

module.exports = (sequelize) => {
  ClubBannerNotificationStatus.init(
    {
    ...
    {
      sequelize,
      modelName: 'ClubBannerNotificationStatus',
      tableName: 'club_banner_notification_status',
      ...
      indexes: [
        {
          name: 'uq_club_banner_notification_status',
          unique: true,
  ...
  return ClubBannerNotificationStatus;
};
